namespace Depra.Common.Extensions
{
    public static class EqualityExtensions
    {
        ...
        public static bool IsNull(this object self) => ReferenceEquals(null, self);
        ...
        public static bool IsNotNull(this object self) => IsNull(self) == false;
        ...
        public static bool IsReferencesMatchWith(this object self, object other) => ReferenceEquals(self, other);
        ...
        public static bool IsTypesMatchWith(this object self, object other) => other.GetType() == self.GetType();
    }
}
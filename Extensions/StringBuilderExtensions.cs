...
namespace Depra.Common.Extensions
{
    ...
    public static class StringBuilderExtensions
    {
        ...
        public static StringBuilder ReplaceFirst(this StringBuilder builder, string search, string replace,
            int startIndex = 0)
            => builder.ReplaceFirst(search, replace, out _, startIndex);

        public static StringBuilder ReplaceFirst(this StringBuilder builder, string search, string replace,
            out int indexOfReplacementStart, int startIndex = 0)
        {
        ...
        /// </summary>
        public static StringBuilder ReplaceAny(this StringBuilder builder, char[] search, char replace,
            int startIndex = 0)
        {
            for (var i = startIndex; i < builder.Length; i++)
            {
        ...
        public static StringBuilder InsertChain(this StringBuilder builder, int index, out int insertionEndIndex,
        ...
        public static StringBuilder PrependChain(this StringBuilder builder, out int insertionEndIndex,
            IEnumerable<string> elements)

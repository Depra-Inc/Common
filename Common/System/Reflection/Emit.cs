...
namespace Depra.Common.System.Reflection
{
    public static class Emit
    {
        public static Func<T> Ctor<T>()
        {
            ...
            var method = new DynamicMethod(type.Namespace + "_Ctor", type, Array.Empty<Type>());
        ...
        {
            var ctor = type.GetTypeInfo().GetConstructor(Array.Empty<Type>());
            var method = new DynamicMethod(type.Namespace + "_CtorObject", type, Array.Empty<Type>());
        ...
        {
            var method = new DynamicMethod(field.DeclaringType.Namespace + "_" + field.Name + "_SetField", typeof(void),

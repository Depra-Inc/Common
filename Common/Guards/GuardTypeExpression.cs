...
{
    public readonly struct GuardTypeExpression
    {
        private readonly Type _this;
        
        private static GuardExpression<Type> Common(Type x) => 
            new GuardExpression<Type>(x);
        
        public GuardTypeExpression(Type @this) => _this = @this;

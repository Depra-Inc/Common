...
namespace Depra.Common.Extensions.Collections
{
    ...
    {
        public static Task ParallelForEachAsync<T>(this IEnumerable<T> self, Func<T, Task> funcBody, int maxDoP = 4)
        {
        ...
        public static Task ParallelForEachAsync<T1, T2>(this IEnumerable<T1> self, Func<T1, T2, Task> funcBody,
        ...
        public static Task ParallelForEachAsync<T1, T2, T3>(this IEnumerable<T1> self,
        ...
        public static Task ParallelForEachAsync<T1, T2, T3, T4>(this IEnumerable<T1> self,

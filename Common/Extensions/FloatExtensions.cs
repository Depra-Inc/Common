...
{
    /// <summary>
    /// Represents extension-methods for <see cref="float"/>.
    /// </summary>
    public static class FloatExtensions
    {
        ...
        /// <summary>
        /// Used for effectively making a loop for a <see cref="float"/>,
        /// so that if it goes below zero it wraps around back to max,
        /// and if it goes above max it wraps around back to zero.
        ...
        /// <summary>
        /// In addition to the nicer syntax, this is significantly faster than <see cref="Math.Pow"/>

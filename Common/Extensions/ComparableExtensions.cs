...
{
    /// <summary>
    /// Represents extension-methods for <see cref="IComparable"/>.
    /// </summary>
    public static class ComparableExtensions
    {
        ...
        /// <param name="than">Value to compare.</param>
        /// <typeparam name="T">Type of comparing values.</typeparam>
        /// <returns>true, if this is less than or equal to <paramref name="than"/>, otherwise false.</returns>
        ...
        /// <param name="than">Value to compare.</param>
        /// <typeparam name="T">Type of comparing values.</typeparam>
        /// <returns>true, if this is greater than <paramref name="than"/>, otherwise false.</returns>
        ...
        /// <param name="than">Value to compare.</param>
        /// <typeparam name="T">Type of comparing values.</typeparam>
        /// <returns>true, if this is greater than or equal to <paramref name="than"/>, otherwise false.</returns>
